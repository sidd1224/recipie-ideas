...
function App() {
  ...
  const handleSearch = (e) => {
    ...
    const apiUrl = `https://recipie-ideas.vercel.app/api/recipes?ingredients=${encodeURIComponent(ingredients)}`;
  ...
  return (
    <div className="App">
      ...
      <footer className="app-footer">
        <p>
          Developed by Your Name | <a href="https://github.com/sidd1224/recipie-ideas" target="_blank" rel="noopener noreferrer">View on GitHub</a>
        </p>
      </footer>
    </div>
  );
